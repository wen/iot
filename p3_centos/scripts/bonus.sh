...
kubectl apply -n argocd -f ../confs/bonus/install.yaml
...
kubectl apply -f ../confs/bonus/ingress.yaml -n argocd
...
kubectl apply -f ../confs/bonus/project.yaml -n argocd
echo "installed project to argocd"
sleep 3

echo "installing application to argocd"
kubectl apply -f ../confs/bonus/application.yaml -n argocd
